...
define('VK_API_CONFIRMATION_TOKEN', 'TOKEN'); // Строка для подтверждения адреса сервера из настроек Callback API
define('VK_API_TOKEN', 'CALLBACK_VK_API'); // Ключ доступа сообщества
